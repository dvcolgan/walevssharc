...
module.exports = function(engine) {
  ...
  engine.addRoom('Steak and Shake (Kitchen)', function() {
    if (this.exactlyMatches('look')) {
      ...
      this.print('How responsible of you.');
      return this.setFlag('oven_open', false);
    } else if (this.matches('take soda') && this.flagIs('oven_open', true)) {
