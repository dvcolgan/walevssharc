...
},{"app/engine":"/home/dcolgan/projects/walevssharc/node_modules/app/engine.coffee","app/view":"/home/dcolgan/projects/walevssharc/node_modules/app/view.coffee"}],"/home/dcolgan/projects/walevssharc/node_modules/app/engine.coffee":[function(require,module,exports){
...
module.exports = Engine = (function() {
  ...
  Engine.prototype.save = function() {
    return localStorage.setItem('progress', {
      room: this.rooms,
  ...
  Engine.prototype.load = function() {
    ...
    return this.currentRoomName = data.currentRoomName;
  };
  ...
  Engine.prototype.doCommand = function(commandText) {
    var cannonicalWord, i, len, synonym, synonyms;
  ...
  Engine.prototype.goToRoom = function(roomName) {
    return this.currentRoomName = roomName;
  };
...
TextTyper = (function() {
  ...
  TextTyper.prototype.onPrint = function(message) {
  ...
  TextTyper.prototype.getPreviousMessages = function() {
...
module.exports = {
  ...
  view: function(ctrl) {
    var currentRoomData, currentRoomName, direction, itemName, state;
    ...
    return [
      m('.sidebar', {
        ...
        var ref, results;
        ref = inventoryStore.getAll();
        results = [];
        for (itemName in ref) {
          state = ref[itemName];
          if (state === 'gotten') {
            results.push(m('p', data.items[itemName].name));
          } else if (state === 'used') {
            results.push(m('p', {
              style: {
...
},{"app/engine":"/home/dcolgan/projects/walevssharc/node_modules/app/engine.coffee","mithril":"/home/dcolgan/projects/walevssharc/node_modules/mithril/mithril.js"}],"/home/dcolgan/projects/walevssharc/node_modules/mithril/mithril.js":[function(require,module,exports){
