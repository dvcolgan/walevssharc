...
TextTyper = (function() {
  ...
  TextTyper.prototype.typeLoop = function() {
    ...
    m.redraw();
    if (!this.isDone()) {
      return setTimeout(this.typeLoop, 4);
    }
  };
...
module.exports = {
  controller: (function() {
    ...
    _Class.prototype.onCommandSubmit = function(e) {
      e.preventDefault();
      console.log(this.vm.typer.isDone());
