...
module.exports = function(engine) {
  ...
  engine.addRoom('Seal or No Seal (Dressing Room - Pick Clothes)', function() {
    if (this.matches('leather jacket')) {
