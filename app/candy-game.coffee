...
module.exports = (engine) ->
    ...
    engine.addRoom 'Candy Room', ->
        if @matches('look')
        ...
        else if @matches('give guy candy bar')
            if @hasItem('candy bar')
            ...
            else if @usedItem('candy bar')
                @print('You definitely already gave the candy bar to him man.  What do you think this is, a candy factory?')
